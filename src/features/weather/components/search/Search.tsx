...
// Types
import { ButtonSize, ButtonType } from '../../../../components/button/Button.types.ts';
...
export function Search() {
    return (
        <div className="flex justify-center items-center gap-[var(--spacing-8)] max-[700px]:flex-col">
            ...
            <Button size={ButtonSize.LARGE} type={ButtonType.PRIMARY} onClick={() => {}} additionalClasses="max-[700px]:w-full">
                Search
            </Button>
        </div>
    );
