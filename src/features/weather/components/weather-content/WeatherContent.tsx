...
export function WeatherContent({ weatherForecast }: WeatherContentProps) {
    return (
        <div className="grid grid-cols-1 min-[1480px]:grid-cols-[2fr_1fr] gap-[var(--spacing-24)] pb-[var(--spacing-22)] [@media(max-height:1080px)]:max-h-[600px] [@media(max-height:1080px)]:pr-[var(--spacing-24)]">
